export default {
  ...
  ENVIRONMENT: {
    EN: {
      ...
      ENV_X_COORD_TITLE: "Get x coordinate of %1",
      ENV_X_COORD_TOOLTIP:
        "Get the x coordinate from an (x, y) coordinate pair.",
      ENV_Y_COORD_TITLE: "Get y coordinate of %1",
      ENV_Y_COORD_TOOLTIP:
        "Get the y coordinate from an (x, y) coordinate pair.",
      ENV_NEIGHBOUR_DIR_TITLE: "Get the neighbour of %1 in %2 direction",
    ...
    RO: {
      ...
      ENV_X_COORD_TITLE: "Obține coordonata x din %1",
      ENV_X_COORD_TOOLTIP:
        "Obține coordonata x a unei perechi de coordonate (x, y).",
      ENV_Y_COORD_TITLE: "Obține coordonata y din %1",
      ENV_Y_COORD_TOOLTIP:
        "Obține coordonata y a unei perechi de coordonate (x, y).",
      ENV_NEIGHBOUR_DIR_TITLE: "Obține vecinul pentru %1 în direcția %2",
      ENV_NEIGHBOUR_DIR_TOOTLTIP:
