...
class Projector {
  ...
  private _projectionAngle: number;
  ...
  project(
    point3: Point3,
    out: Phaser.Geom.Point = new Point()
  ): Phaser.Geom.Point {
  ...
  projectXY(
    ...
    out.x += this.game.scale.gameSize.width * this.origin.x;
    out.y += this.game.scale.gameSize.height * this.origin.y;
  ...
  unproject(
    ...
    const x =
      point.x -
      this.game.scale.gameSize.width * this.origin.x +
      this.scene.cameras.main.scrollX;
    // point.x - this.game.world.x - this.game.world.width * this.origin.x;
    const y =
      point.y -
      this.game.scale.gameSize.height * this.origin.y +
      this.scene.cameras.main.scrollY +
      z;
    // point.y - this.game.world.y - this.game.world.height * this.origin.y + z;
