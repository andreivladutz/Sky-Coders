...
class Point3 {
   ...
   */
  copyFrom(source: { x: number; y: number; z: number }): Point3 {
  ...
  copyTo(dest: object): object {
    return Object.assign(dest, this);
  }
   ...
   */
  equals(a: Point3 | { x?: number; y?: number; z?: number }): boolean {
   ...
   */
  static add(a: Point3, b: Point3, out: Point3 = new Point3()): Point3 {
    out.x = a.x + b.x;
    out.y = a.y + b.y;
    out.z = a.z + b.z;
   ...
   * @return {Point3} The new Point3 object.
   */
  static subtract(a: Point3, b: Point3, out: Point3 = new Point3()): Point3 {
    out.x = a.x - b.x;
    out.y = a.y - b.y;
    out.z = a.z - b.z;
   ...
   * @return {Point3} The new Point3 object.
   */
  static multiply(a: Point3, b: Point3, out: Point3 = new Point3()): Point3 {
    out.x = a.x * b.x;
    out.y = a.y * b.y;
    out.z = a.z * b.z;
   ...
   * @return {Point3} The new Point3 object.
   */
  static divide(a: Point3, b: Point3, out: Point3 = new Point3()): Point3 {
    out.x = a.x / b.x;
    out.y = a.y / b.y;
    out.z = a.z / b.z;
